...
<div style="padding: 10px;">
<label>Option 3:</label> <br> <input type="text" name="options3"value="<%=q.getOpt3()%>">
</div>
<div style="padding: 10px;">
<label>Option 4:</label> <br> <input type="text" name="options4"value="<%=q.getOpt4()%>">
</div>
<div style="padding: 10px;">
<label>Correct Option:</label> <br> <input type="text"name="correctOptions" value="<%=q.getCorrectopt()%>">
<div style="padding: 10px;">
